...
> [!IMPORTANT]
> Note that on Android 9 (API 28), the `--user-type` flag is not supported (it was introduced in Android 11). We must use the `--managed` flag to declare the new profile as a secure managed profile user.
...
| --- | --- |
| ![NTP DIG PING MORE in secure Work Profile (Android 9) BYOD](/images/workprofile_launch_9_byod.png) | ![NTP DIG PING MORE in secure Work Profile (Android 9) WP](/images/workprofile_launch_9_wp.png) |
| | ![NTP DIG PING MORE in secure Work Profile (Android 9)](/images/workprofile_launch_9.png) |
