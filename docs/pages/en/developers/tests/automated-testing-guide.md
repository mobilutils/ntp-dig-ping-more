...
description: Comprehensive unit test suite for business logic, ViewModels, and data parsing — running, coverage, patterns, and best practices.
---

# Automated Testing Guide

This project maintains a comprehensive unit test suite covering business logic, ViewModels, and data parsing across all major feature modules.
...
```bash
./gradlew test --tests "io.github.mobilutils.ntp_dig_ping_more.NtpViewModelTest"
```

### Run a specific test method

```bash
./gradlew test --tests "io.github.mobilutils.ntp_dig_ping_more.NtpViewModelTest.checkReachability handles DNS failure"
```
...
All ViewModels expose state via `StateFlow<UiState>` (e.g. `NtpUiState`):
...
4. Measure test coverage with JaCoCo (see [JaCoCo Setup Guide](/en/developers/tests/jacoco-setup))
...
- [JaCoCo Code Coverage](https://www.jacoco.org/jacoco/trunk/doc/index.html)
