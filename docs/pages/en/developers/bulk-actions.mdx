...
19 fields — the most complex UI state in the app. Covers config loading, execution state, progress tracking, results, file I/O, validation messages, and MDM bulk actions integration.
