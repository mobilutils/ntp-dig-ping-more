...
description: Here we'll cover the visible piece of the icebergz
---

## Available features
Below a walkthrough screen by screen
## 
...
<div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', marginBottom: '32px' }}>
     ...
     <div style={{ width: '50%' }}>
        <Img src="/images/3_screencap_ping.png" alt="NTP Check" style={{ maxWidth: '100%', width: '100%', height: 'auto', border: '1px solid #e5e7eb', borderRadius: '8px' }} />
     </div>
</div>

## MORE (the name of the app ;))
...
<div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', marginBottom: '32px' }}>
     ...
     <div style={{ width: '50%' }}>
        <Img src="/images/5_screencap_settings.png" alt="NTP Check" style={{ maxWidth: '100%', width: '100%', height: 'auto', border: '1px solid #e5e7eb', borderRadius: '8px' }} />
     </div>
</div>
...
<div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', marginBottom: '32px' }}>
     ...
     <div style={{ width: '50%' }}>
        <Img src="/images/7_screencap_traceroute.png" alt="NTP Check" style={{ maxWidth: '100%', width: '100%', height: 'auto', border: '1px solid #e5e7eb', borderRadius: '8px' }} />
     </div>
</div>
...
<div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', marginBottom: '32px' }}>
     ...
     <div style={{ width: '50%' }}>
        <Img src="/images/9_screencap_lanscan.png" alt="NTP Check" style={{ maxWidth: '100%', width: '100%', height: 'auto', border: '1px solid #e5e7eb', borderRadius: '8px' }} />
     </div>
</div>
...
<div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', marginBottom: '32px' }}>
     ...
     <div style={{ width: '50%' }}>
        <Img src="/images/11_screencap_checkcert.png" alt="NTP Check" style={{ maxWidth: '100%', width: '100%', height: 'auto', border: '1px solid #e5e7eb', borderRadius: '8px' }} />
     </div>
</div>
