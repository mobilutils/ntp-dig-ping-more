...
- Graceful error handling: DNS failure, timeout, no network | ![NTP Check](/images/1_screencap_ntp.png) |
|---|---|
...
- Graceful error handling: NXDOMAIN, resolver unreachable, no network| ![DIG](/images/2_screencap_dig.png) |
|---|---|
...
- History icon reflects the outcome:
  ...
  - ❌ No reply received
- Last 5 pinged hosts kept as clickable history (persisted across app restarts) | ![Ping](/images/3_screencap_ping.png) |